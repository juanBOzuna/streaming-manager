...
class AdminOrderDetailsScreenExpiredTomorrowController extends \crocodicstudio\crudbooster\controllers\CBController
{
	...
	public function cbInit()
	{
		...
		// $this->col[] = ["label"=>"Orders Id","name"=>"orders_id","join"=>"orders,id"];
		$this->col[] = ["label" => "Tipo", "name" => "type_account_id", "join" => "type_account,name"];
		$this->col[] = ["label" => "Cliente", "name" => "customer_id", "join" => "customers,id", "callback" => function ($row) {
			$customer = Customers::where('id', '=', $row->customer_id)->first();
			return "" . $customer->name  . " - " . $customer->number_phone;
		}];
		// $this->col[] = ["label"=>"Number Screens","name"=>"number_screens"];
		$this->col[] = ["label" => "Id pantalla", "name" => "screen_id", "join" => "screens,id"];
		$this->col[] = ["label" => "Cuenta", "name" => "account_id", "join" => "accounts,email"];
		$this->col[] = ["label" => "Dias membresia", "name" => "membership_days"];
