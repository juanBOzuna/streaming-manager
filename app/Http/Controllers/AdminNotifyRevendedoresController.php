...
class AdminNotifyRevendedoresController extends \crocodicstudio\crudbooster\controllers\CBController
{
	...
	public function cbInit()
	{
		...
		if (null != $_REQUEST["isSuccess"]) {
			...
			echo "
					...
					window.location.href = 'http://streaming-manager.test/admin/notify_revendedores?isSendSms=1'
		...
		if (null != $_REQUEST["sendMessageSuccesfull"]) {
			...
			\crocodicstudio\crudbooster\helpers\CRUDBooster::redirect("http://streaming-manager.test/admin/notify_revendedores", "El cliente fue avisado exitosamente 2", "success");
		}
	...
	public function getSetWhatsapp($id)
	{
		...
		$details = OrderDetail::where('customer_id', '=', $id)->where('is_notified', '=', '0')->where('is_venta_revendedor', '=', 1)->get();
