<?php namespace App\Http\Controllers;
	...
	class AdminOrders35Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Is Discarded All","name"=>"is_discarded_all","type"=>"radio","required"=>TRUE,"validation"=>"required|integer","dataenum"=>"Array"];
			...
			//$this->form[] = ["label"=>"Number Screens Discarded","name"=>"number_screens_discarded","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			# OLD END FORM
