<?php namespace App\Http\Controllers;
	...
	class AdminOrderDetails22Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Is Notified Renovation","name"=>"is_notified_renovation","type"=>"radio","required"=>TRUE,"validation"=>"required|integer","dataenum"=>"Array"];
