...
class AdminTypeAccountController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    public function cbInit()
    {
        ...
        $this->table = "type_account";
        # END CONFIGURATION DO NOT REMOVE THIS LINE

        # START COLUMNS DO NOT REMOVE THIS LINE
        $this->col = [];
        $this->col[] = ["label" => "Nombre", "name" => "name"];
        $this->col[] = ["label" => "Pantallas totales", "name" => "total_screens"];
        $this->col[] = ["label" => "pantallas vendibles", "name" => "available_screens"];
        ...
        $this->form[] = ['label' => 'Pantallas totales', 'name' => 'total_screens', 'type' => 'number', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10'];
        ...
        //$this->form[] = ["label"=>"Total Screens","name"=>"total_screens","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
        //$this->form[] = ["label"=>"Available Screens","name"=>"available_screens","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
