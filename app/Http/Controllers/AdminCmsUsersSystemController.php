<?php namespace App\Http\Controllers;
	...
	class AdminCmsUsersSystemController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"link bot","name"=>"link_bot"];
			...
			$this->form[] = ['label'=>'Telefono','name'=>'number_phone','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			...
			$this->form[] = ['label'=>'Privilegios','name'=>'id_cms_privileges','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'cms_privileges,name'];
			//$this->form[] = ['label'=>'Status','name'=>'status','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Link del Bot','name'=>'link_bot','type'=>'text','validation'=>'min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Link Bot","name"=>"link_bot","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
