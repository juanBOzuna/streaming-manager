...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ["id" => "3","name" => "Tipos de cuentas","type" => "Route","path" => "AdminTypeAccountControllerGetIndex","color" => NULL,"icon" => "fa fa-key","parent_id" => "0","is_active" => "1","is_dashboard" => "0","id_cms_privileges" => "1","sorting" => "11","created_at" => "2021-10-18 18:43:09","updated_at" => NULL],
            ["id" => "4","name" => "Recargas","type" => "Route","path" => "AdminRecargasControllerGetIndex","color" => "normal","icon" => "fa fa-phone","parent_id" => "0","is_active" => "1","is_dashboard" => "0","id_cms_privileges" => "1","sorting" => "9","created_at" => "2021-10-24 21:38:56","updated_at" => "2021-10-24 22:47:20"],
            ["id" => "5","name" => "Tipo de recargas","type" => "Route","path" => "AdminTipoDeRecargasControllerGetIndex","color" => NULL,"icon" => "fa fa-check","parent_id" => "0","is_active" => "1","is_dashboard" => "0","id_cms_privileges" => "1","sorting" => "10","created_at" => "2021-10-24 21:44:31","updated_at" => NULL],
            ["id" => "9","name" => "Clientes","type" => "Route","path" => "AdminCustomersControllerGetIndex","color" => "normal","icon" => "fa fa-user","parent_id" => "0","is_active" => "1","is_dashboard" => "0","id_cms_privileges" => "1","sorting" => "13","created_at" => "2021-12-08 16:10:11","updated_at" => "2022-05-15 23:04:20"],
            ...
            ["id" => "18","name" => "Usuarios","type" => "Route","path" => "AdminCmsUsersSystemControllerGetIndex","color" => NULL,"icon" => "fa fa-user","parent_id" => "0","is_active" => "1","is_dashboard" => "0","id_cms_privileges" => "1","sorting" => "14","created_at" => "2022-07-14 16:09:58","updated_at" => NULL],
            ["id" => "19","name" => "Renovar Pantallas","type" => "Route","path" => "AdminOrderDetailsRenovationsControllerGetIndex","color" => "normal","icon" => "fa fa-refresh","parent_id" => "0","is_active" => "1","is_dashboard" => "0","id_cms_privileges" => "1","sorting" => "7","created_at" => "2022-07-14 18:05:52","updated_at" => "2022-08-05 20:19:45"],
            ["id" => "20","name" => "Revendedores","type" => "Route","path" => "AdminRevendedoresControllerGetIndex","color" => "normal","icon" => "fa fa-user","parent_id" => "0","is_active" => "1","is_dashboard" => "0","id_cms_privileges" => "1","sorting" => "12","created_at" => "2022-08-01 01:23:40","updated_at" => "2022-08-05 17:42:09"],
            ...
            ["id" => "22","name" => "Avisar Revendedores","type" => "Route","path" => "AdminNotifyRevendedoresControllerGetIndex","color" => NULL,"icon" => "fa fa-bell","parent_id" => "0","is_active" => "1","is_dashboard" => "0","id_cms_privileges" => "1","sorting" => "15","created_at" => "2022-08-05 19:42:57","updated_at" => NULL],
            ["id" => "23","name" => "Renovar Cuentas completas","type" => "Route","path" => "AdminOrderDetailsRenovationsFullAccountControllerGetIndex","color" => NULL,"icon" => "fa fa-refresh","parent_id" => "0","is_active" => "1","is_dashboard" => "0","id_cms_privileges" => "1","sorting" => "8","created_at" => "2022-08-05 20:21:28","updated_at" => NULL]
        ];
        foreach ($data as $k => $d) {
  ...
  ["id" => "33","name" => "Renovar Cuentas completas","icon" => "fa fa-refresh","path" => "order_details_renovations_full_account","table_name" => "order_details","controller" => "AdminOrderDetailsRenovationsFullAccountController","is_protected" => "0","is_active" => "0","created_at" => "2022-08-05 20:21:27","updated_at" => NULL,"deleted_at" => NULL]
        ...
        $data = [
            ...
            ["id" => "1","is_visible" => "1","is_create" => "0","is_read" => "0","is_edit" => "0","is_delete" => "0","id_cms_privileges" => "1","id_cms_moduls" => "1","created_at" => "2022-08-04 11:49:14","updated_at" => NULL],
            ["id" => "2","is_visible" => "1","is_create" => "1","is_read" => "1","is_edit" => "1","is_delete" => "1","id_cms_privileges" => "1","id_cms_moduls" => "2","created_at" => "2022-08-04 11:49:14","updated_at" => NULL],
            ["id" => "3","is_visible" => "0","is_create" => "1","is_read" => "1","is_edit" => "1","is_delete" => "1","id_cms_privileges" => "1","id_cms_moduls" => "3","created_at" => "2022-08-04 11:49:14","updated_at" => NULL],
            ["id" => "4","is_visible" => "1","is_create" => "1","is_read" => "1","is_edit" => "1","is_delete" => "1","id_cms_privileges" => "1","id_cms_moduls" => "4","created_at" => "2022-08-04 11:49:14","updated_at" => NULL],
            ["id" => "5","is_visible" => "1","is_create" => "1","is_read" => "1","is_edit" => "1","is_delete" => "1","id_cms_privileges" => "1","id_cms_moduls" => "5","created_at" => "2022-08-04 11:49:14","updated_at" => NULL],
            ["id" => "6","is_visible" => "1","is_create" => "1","is_read" => "1","is_edit" => "1","is_delete" => "1","id_cms_privileges" => "1","id_cms_moduls" => "6","created_at" => "2022-08-04 11:49:14","updated_at" => NULL],
            ["id" => "7","is_visible" => "1","is_create" => "1","is_read" => "1","is_edit" => "1","is_delete" => "1","id_cms_privileges" => "1","id_cms_moduls" => "7","created_at" => "2022-08-04 11:49:14","updated_at" => NULL],
            ["id" => "8","is_visible" => "1","is_create" => "1","is_read" => "1","is_edit" => "1","is_delete" => "1","id_cms_privileges" => "1","id_cms_moduls" => "8","created_at" => "2022-08-04 11:49:14","updated_at" => NULL],
            ["id" => "9","is_visible" => "1","is_create" => "1","is_read" => "1","is_edit" => "1","is_delete" => "1","id_cms_privileges" => "1","id_cms_moduls" => "9","created_at" => "2022-08-04 11:49:14","updated_at" => NULL],
            ["id" => "10","is_visible" => "1","is_create" => "1","is_read" => "1","is_edit" => "1","is_delete" => "1","id_cms_privileges" => "1","id_cms_moduls" => "10","created_at" => "2022-08-04 11:49:14","updated_at" => NULL],
            ["id" => "11","is_visible" => "1","is_create" => "0","is_read" => "1","is_edit" => "0","is_delete" => "1","id_cms_privileges" => "1","id_cms_moduls" => "11","created_at" => "2022-08-04 11:49:14","updated_at" => NULL],
  ...
  ["id" => "2","name" => "Amazon Peime","total_screens" => "6","available_screens" => "3","extraordinary_available_screens" => "4","price_day" => "2500","picture" => NULL,"created_at" => "2021-10-18 21:58:32","updated_at" => "2022-08-05 17:11:49","price_full" => "30000"],
